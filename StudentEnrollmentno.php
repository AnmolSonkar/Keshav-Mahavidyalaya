...
<body>
  ...
  <div class="mx-auto" id="boxwidth">
    <h2 class="mt-lg-5" id="HeadTitle" data-aos="fade-right">
      <img class="img-fluid mr-1 mb-1" id="cardicon1" src="IMG/ENROLMENT.webp">
    ...
    <div class="jumbotron mt-4  mx-auto" id="SPBG" data-aos="fade-up">
      <div class="container text-white" id="list" data-aos="fade">
        <ul class="list-group ">
          <li class="list-group-item m-1"> <i class="fa fa-file-pdf-o mr-2 " id="pdf"></i><a href="uploads/notices/KEMV_EnrollmentNo_2018.pdf">Enrolment Numbers Academic Session 2018-2019
            </a> </li>
          <li class="list-group-item m-1"> <i class="fa fa-file-pdf-o mr-2 " id="pdf"></i><a href="uploads/notices/KEMV_EnrollmentNo_2017.pdf">Enrolment Numbers Academic Session 2017-2018
            </a> </li>
        </ul>
      </div>
    </div>
