...
<body>
  ...
  <div class="mx-auto" id="boxwidth">
    <h2 class="mt-lg-5" id="HeadTitle" data-aos="fade-right">
      <img class="img-fluid mr-1 mb-1 rounded-circle" id="cardicon1" src="IMG/TEACHING.webp">
    Roster - Teaching (Draft)
    </h2>
    <div class="jumbotron mt-4  mx-auto" id="SPBG" data-aos="fade-up">
      <div class="container text-white" id="list" data-aos="fade">
        <ul class="list-group ">
          <li class="list-group-item m-1"> <i class="fa fa-file-pdf-o mr-2 " id="pdf"></i><a href="uploads/usefullinks/roster/Teaching_Roster_200_04_06_2019.pdf">Roster Teaching (200 Point)
            </a> </li>
          <li class="list-group-item m-1"> <i class="fa fa-file-pdf-o mr-2 " id="pdf"></i><a href="uploads/usefullinks/roster/Teaching_Roster_100_point.pdf">Roster Teaching (100 Point)
            </a> </li>
        </ul>
      </div>
    </div>
