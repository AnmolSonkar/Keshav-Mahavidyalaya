    ...
    <div class="mx-auto" id="boxwidth">
      ...
      <div class="jumbotron mt-4  mx-auto" id="SPBG" data-aos="fade-up">
       <div class="container text-white" id="list" data-aos="fade">
        <ul class="list-group text-white" id="font">
          <li class="list-group-item m-1"> <i class="fa fa-users text-white mr-2 "></i><a href="Facultytimetable">Faculty</a> </li>
          <li class="list-group-item m-1"> <i class="fa fa-graduation-cap text-white mr-2 "></i><a href="Coursetimetable">Course</a></li>
          <li class="list-group-item m-1"> <i class="fa fa-cog text-white mr-2 "></i><a href="GEtimetable">Generic Elective</a></li>

          <li class="list-group-item m-1"> <i class="fa fa-flask text-white mr-2 "></i><a href="Labtimetable">Laboratory</a></li>
        </ul>
      </div>
    </div>
  </div>
