...
<body>
  ...
  <div class="mx-auto" id="boxwidth">
    <h2 class="mt-lg-5" id="HeadTitle" data-aos="fade-right">
      <img class="img-fluid mr-1 mb-1" id="cardicon1" src="IMG/RADIO.webp">
  Add-on Course in Radio Broadcasting (Duration : 40 Hours)
    </h2>
    <div class="jumbotron mt-4  mx-auto" id="SPBG" data-aos="fade-up">
      <table class="table table-bordered" id="background" data-aos="fade">
        ...
        <tbody>
          <tr>
            <td>Add-on Course in Radio Broadcasting</td>
            <td>25</td>
            <td>On the basis of First Come First Serve</td>
          </tr>
        </tbody>
      </table>
    </div>
