...
<body>
  <div id="MobileTop"><?php include("Navbar2.php"); ?></div>
  <div class="d-lg-none"><?php include("Socialbar2.php")?></div>
  <div id="Sidebar"><?php include("Sidebar.php"); ?></div>

  <div class="mx-auto" id="boxwidth">
    <h2 class="mt-lg-5" id="HeadTitle" data-aos="fade-right">
      <img class="img-fluid mr-1 mb-1" id="cardicon1" src="IMG/REPORT.webp">
     IQAC - AQAR Reports
    </h2>
      ...
      <div class="container text-white" id="list" data-aos="fade" >
        <ul class="list-group " >
          ...
          <li class="list-group-item m-1">
            <i class="fa fa-file-pdf-o mr-2 " id="pdf"></i><a  href="uploads/usefullinks/iqac/aqar2018-19.pdf">AQAR 2018-19
            </a>
          </li>
          <li class="list-group-item m-1">
            <i class="fa fa-file-pdf-o mr-2 " id="pdf"></i><a  href="uploads/usefullinks/iqac/AQAR2017-18.pdf">AQAR 2017-18
            </a>
          </li>
              <li class="list-group-item m-1">
            <i class="fa fa-file-pdf-o mr-2 " id="pdf"></i><a  href="uploads/usefullinks/iqac/AQAR2016-17.pdf">AQAR 2016-17
            </a>
          </li>
        </ul>
      </div>
