...
<body>
  ...
  <div class="mx-auto" id="boxwidth">
    ...
    Distribution of Sports Quota Seats 2020-2021
    </h2>
    <div class="jumbotron mt-4  mx-auto" id="SPBG" data-aos="fade-up">
      <table class="table table-bordered" id="background" data-aos="fade">
        ...
        <tbody>
          <tr>
            <td><b>Total Sports Quota Seats</b> </td>
            <td><b>Number of Seats=18</b></td>
          </tr>
          <tr>
            <td>*The bifurcation of the sports quota seats will be updated soon.</td>
            <td></td>
          </tr>
        </tbody>
      </table>
