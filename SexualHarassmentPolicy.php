...
<body>
  ...
  <div class="mx-auto" id="boxwidth">
    <h2 class="mt-lg-5" id="HeadTitle" data-aos="fade-right">
      <img class="img-fluid mr-1 mb-1" id="cardicon1" src="IMG/LAW.svg">
      Policy on prevention of Sexual Harassment
    </h2>
    <div class="jumbotron mt-4  mx-auto" id="SPBG" data-aos="fade">
      <div class="container text-white" id="list" data-aos="fade-right">
        <ul class="list-group ">
          <li class="list-group-item m-1"> <i class="fa fa-file-pdf-o mr-2 " id="pdf"></i><a href="uploads/discipline/Sexual_harassment_policy.pdf">Policy on prevention of Sexual Harassment
            </a> </li>
        </ul>
      </div>
    </div>
